    ...
    if (receipt.type === 'International Transfer') {
        return `
            <div class="international-receipt -m-4 p-4 sm:p-5 text-xs">
                ...
                <div class="mt-4"><div class="receipt-section-title">Ordering institution</div><div class="receipt-row"><span>Account holder</span><strong>${receipt.senderName || 'Account holder'}</strong></div><div class="receipt-row"><span>Bank name</span><strong>American Bank United</strong></div><div class="receipt-row"><span>SWIFT / BIC</span><strong>ABUUS768</strong></div><div class="receipt-row"><span>Debit account</span><strong>${receipt.senderAccountNumber || receipt.from || 'Not available'}</strong></div><div class="receipt-row"><span>Sender phone</span><span>${receipt.senderPhone || 'Not provided'}</span></div><div class="receipt-row"><span>Send advice by e-mail</span><span>${receipt.senderEmail || 'Not provided'}</span></div></div>
