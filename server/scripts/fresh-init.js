...
async function cleanAndInit() {
    ...
    try {
        ...
        await client.query('DROP TABLE IF EXISTS bill_payments CASCADE');
        await client.query('DROP TABLE IF EXISTS billers CASCADE');
        ...
        `);
        await client.query(`CREATE INDEX idx_accounts_user_id ON accounts(user_id)`);
        await client.query(`CREATE INDEX idx_accounts_number ON accounts(account_number)`);
        ...
        await client.query(`CREATE INDEX idx_transactions_created ON transactions(created_at)`);
        ...
        `);
        await client.query(`CREATE INDEX idx_cards_user_id ON cards(user_id)`);
        await client.query(`CREATE INDEX idx_cards_number ON cards(card_number)`);
        ...
        `);
        await client.query(`CREATE INDEX idx_billers_user_id ON billers(user_id)`);
        console.log('✅ Billers table');
        ...
        `);
        await client.query(`CREATE INDEX idx_bill_payments_biller ON bill_payments(biller_id)`);
        await client.query(`CREATE INDEX idx_bill_payments_date ON bill_payments(payment_date)`);
